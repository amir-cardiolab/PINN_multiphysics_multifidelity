...
# Solve 2D steady N.S in An Aneurysm
...
# PDE loss
    ...
    if (Flag_pretrain):
        ...
        net2_u.load_state_dict(torch.load(path+"fwd_step_u_anurysm_from_fluent_6layers_200"+".pt"))
        net2_v.load_state_dict(torch.load(path+"fwd_step_v_anurysm_from_fluent_6layers_200"+".pt"))
...
Lambda_BC  = 70 # weigh boundary condition loss
